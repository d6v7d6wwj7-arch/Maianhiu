...
const defaultHeartImages = Array.from({ length: 15 }, (_, i) => `images/img${i + 1}.jpg`);
...
const ringTexts = [
  'Meeting you is the best thing that ever happened to me',//untuk deskripsi planet layer 1
  "I love you in every universe",//untuk deskripsi planet layer 2
  "Today, tomorrow, forever",//untuk deskripsi planet layer 3
